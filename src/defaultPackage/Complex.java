...
public class Complex implements Serializable{
	 ...
	 * @return	The multiplication of two complex numbers.  New Complex object.
	 */
	 ...
	 * @return	The calling complex number times the passed real number.  New Complex object.
	 */
	public static Complex multiply(Complex one, double c) { return new Complex(one.re * c, one.im * c); }
	
	/**
	 * Method to add two complex numbers
	 * @param toAdd	The second complex number to add
	 * @return	The sum of the calling complex number and the passed complex number.   New Complex object.
	 */
	public static Complex add(Complex one, Complex two) { return new Complex(one.re + two.re, one.im + two.im); }
	
	/**
	 * Method to add a double to the calling complex number.
	 * @param toAdd	The double to add to the calling complex.
	 * @return	(a + ib) + (c) = new Complex(a + c, b).  New Complex object.
	 */
	public static Complex add(Complex one, double c) { return new Complex(one.re + c, one.im); }
	
	/**
	 * Method to calculate the exponential value of this complex number in the form exp(a + bi) = exp(a)*(cos(b) + i*sin(b))
	 * @return	The complex value of exp(a + bi).   New Complex object.
	 */
	public static Complex exponential(Complex one)
	{
	 ...
	 * @return		The conjugate of this complex number.   New Complex object.
	 */
	public Complex conjugate() { return new Complex(re, -1 * im); }
	...
	public Object clone() { return new Complex(re, im); }
	/**
