...
public class Thread_CalculateDiffraction extends Observable implements Runnable {

	private CalculateDiffraction calc;
	public final static String COMPLETE = "DIFFRACTION_COMPLETE";
	private MyPrintStream mpsLog;
	
	public Thread_CalculateDiffraction(CalculateDiffraction calc, MyPrintStream mps) {
		this.calc = calc;
		mpsLog = mps;
	...
	public void run() {
		...
		JAtom[] lattice = calc.getFractionalAtoms();
